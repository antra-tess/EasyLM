...
def flash_attention(
    ...
    def chunk_scanner(carry, idx_n):
        ...
        def kv_chunk_scanner(carry, idx_k):
            ...
            print("Block scores shape: {}", scores.shape)
            print("Query block [0,1] (middle token): {}", q[0, 1])
            print("Key block [0,0] (first token): {}", k[0, 0])
            print("Raw scores for middle token: {}", scores[0, :, 1])
            ...
            print("Post-softmax scores for middle token: {}", scores[0, :, 1])
