...
python -m EasyLM.test_inference \
    ...
    --load_checkpoint='base_params::/mnt/disk3/llama-3.2-1b.easylm' \
    --input_length=1024 \
    --seq_length=2048 \
    --do_sample=True \
    --top_k=150 \
    --top_p=0.99 \
    --lm_server.port=5009 \
    --load_lora='base_params::/mnt/disk3/easylm_chkp/30bf244bf80c464d854f0c1addf55409/checkpoint_1000/streaming_params' \
    --lora_mode=True \
    --llama.lora_rank=16 \
    --llama.lora_alpha=32 \
