...
gcloud compute tpus tpu-vm ssh finetune-70b --zone=us-central2-b --worker=all --command="cd /tmp/EasyLM && export PYTHONPATH=/tmp/EasyLM:\${PYTHONPATH} && python -m EasyLM.models.llama.llama_train \
    --mesh_dim='1,-1,1' \
